              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    ...
                    <strong>{u.full_name || u.email}</strong>. They will be able to
                    manage resources, blog posts, users, and all admin settings. Are
                    you sure?
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    ...
                    <strong>{u.full_name || u.email}</strong>. They will no longer be
                    able to access the admin dashboard. This can be undone at any time.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
                  <AlertDialogCancel>Cancel</AlertDialogCancel>
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    This permanently removes {u.full_name} ({u.email}), their profile
                    and role. This action cannot be undone.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
                  <AlertDialogCancel>Cancel</AlertDialogCancel>
          ...
          <Tabs defaultValue="users" className="space-y-6">
            ...
            <TabsContent value="users">
              <div className="mb-3 flex items-center gap-2 p-3 rounded-xl bg-green-50 border border-green-200 text-green-800 text-sm">
                ...
                <span>
                  Click <strong>Authorize Admin</strong> next to a user to grant them admin access. They will immediately be able to log into the admin dashboard.
                </span>
              </div>
              <UserTable
                rows={regularUsers}
            ...
            <TabsContent value="admins">
              <div className="mb-3 flex items-center gap-2 p-3 rounded-xl bg-orange-50 border border-orange-200 text-orange-800 text-sm">
                ...
                <span>
                  You can <strong>Revoke Admin</strong> access from any admin below (except your own account). Their access will be removed immediately.
                </span>
              </div>
              <UserTable
                rows={admins}
